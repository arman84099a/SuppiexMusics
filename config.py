...
API_KEY = getenv("API_KEY", 'xbit_3WDBc5LDhYcMq3SqIj3yn0BWxRJCHnBa') # youtube song api key, generate free key or buy paid plan from https://console.nexgenbots.xyz
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/SuppieChat")
